...
export default async function ListCard({title}: Props) {
  return (
      <div className="max-w-full p-8 bg-gray-800 rounded-lg shadow-lg text-gray-200 sm:w-1/2 w-screen">
            ...
            <div className="flex flex-col gap-y-1">
                ...
                <div>
                    <input className={`${styles.listItem} hidden`} type="checkbox" id="task_7"/>
                    <label className="flex items-center min-h-10 px-2 rounded cursor-pointer hover:bg-gray-900" htmlFor="task_7">
                        <span className="flex items-center justify-center w-5 min-h-5 text-transparent border-2 border-gray-500 rounded-full">
                            <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                ...
                <div>
                    <input className={`${styles.listItem} hidden`} type="checkbox" id="task_8" />
                    <label className="flex items-center min-h-10 px-2 rounded cursor-pointer hover:bg-gray-900" htmlFor="task_8">
                        <span className="flex items-center justify-center w-5 min-h-5 text-transparent border-2 border-gray-500 rounded-full">
                            <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                ...
                <div>
                    <input className={`${styles.listItem} hidden`} type="checkbox" id="task_9" />
                    <label className="flex items-center min-h-10 px-2 rounded cursor-pointer hover:bg-gray-900" htmlFor="task_9">
                        <span className="flex items-center justify-center w-5 min-h-5 text-transparent border-2 border-gray-500 rounded-full">
                            <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
                ...
                <div>
                    <input className={`${styles.listItem} hidden`} type="checkbox" id="task_10" />
                    <label className="flex items-center min-h-10 px-2 rounded cursor-pointer hover:bg-gray-900" htmlFor="task_10">
                        <span className="flex items-center justify-center w-5 min-h-5 text-transparent border-2 border-gray-500 rounded-full">
                            <svg className="w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                            </svg>
			...
			<button className="flex items-center w-full h-8 px-2 mt-2 text-sm font-medium rounded">
				<svg className="w-5 min-h-5 text-gray-400 fill-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
